export const VACANCIES = {
  ...
  items: [
    // Frontend разработчик в казино
    {
      ...
      snippet: {
        requirement:
          "Высшее образование. Опыт работы в качестве <highlighttext>Frontend разработчик в казино</highlighttext>, офис-менеджера. Знание делопроизводства, документооборота. Коммуникативные навыки.",
        responsibility:
    ...
    // Frontend разработчик в стартап
{
  ...
  url: "https://api.hh.ru/vacancies/1",
...

    {
      ...
      url: "https://api.hh.ru/vacancies/8331233",
    },
